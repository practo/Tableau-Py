...
# pylint: skip-file
#
# AutoExtract documentation build configuration file, created by
...
#html_title = u'AutoExtract v1.0.0'
...
htmlhelp_basename = 'AutoExtractdoc'
...
extlinks = {
    'tableausdk': ('https://onlinehelp.tableau.com/current/api/sdk/en-us/SDK/Python/html/%s.html', 'path')
}
