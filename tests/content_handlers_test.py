...
class TestTDSContentHandler(unittest.TestCase):
    ...
    def _fail_on_connection_duplication(self, tds_xml, element): # pylint: disable=locally-disabled,invalid-name
        """
    ...
    def test_parse(self):
        ...
        self._fail_on_connection_duplication(tds_xml, connection_inside)
        self._fail_on_connection_duplication(tds_xml, named_connection)
        self._fail_on_connection_duplication(tds_xml, named_connections)
        self._fail_on_connection_duplication(tds_xml, connection)
